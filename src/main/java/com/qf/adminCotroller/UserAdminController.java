...
public class UserAdminController extends BaseController{
    ...
    protected String all(HttpServletRequest req, HttpServletResponse resp){
        ...
        //每页行数
        int limit = 2;
        List<User> catalogs = new UserServiceImpl().allUser();
        //总页数
        ...
        //调用service返回结果
        List<User> ulist = new UserServiceImpl().allUser(page1, limit);
        //跳转jsp页面,并且携带数据;
        //c发起1/2次请求
        req.setAttribute("ulist", ulist);//集合对象
        ...
        return "forward:/admin/mange/user.jsp";
    }
}
